...
private:
    ...
    void pickPhysicalDevice()
    {
        ...
        else
        {
            ...
            std::cout << "Physicial device chosen: " << deviceProperties.deviceName << std::endl;
        }
    }
    ...
    void createLogicalDevice()
    {
        ...
        std::set<uint32_t> queueFamilies = { indices.graphicsFamily, indices.presentFamily };
    ...
    void createSwapChain()
    {
        ...
        if (vkCreateSwapchainKHR(logicalDevice, &createInfo, nullptr, &swapChain) != VK_SUCCESS)
            ...
            std::cout << "Vulkan swapchain successfully created !" << std::endl;
    ...
    void createImageViews()
    {
        ...
        for (size_t i = 0; i < swapChainImages.size(); i++)
        {
            ...
            if (vkCreateImageView(logicalDevice, &createInfo, nullptr, &swapChainImageViews[i]) != VK_SUCCESS)
                ...
                std::cout << "Swap chain image view " + std::to_string(i) + "/" + std::to_string(swapChainImages.size()) + " successfully created !" << std::endl;
        }
    ...
    void createGraphicsPipeline()
    {
        ...
        if (vkCreatePipelineLayout(logicalDevice, &pipelineLayoutInfo, nullptr, &pipelineLayout) != VK_SUCCESS)
            ...
            std::cout << "Vulkan pipeline layout successfully created !" << std::endl;
    ...
    void createFramebuffers()
    {
        ...
        for (size_t i = 0; i < swapChainImageViews.size(); i++)
        {
            ...
            if (vkCreateFramebuffer(logicalDevice, &framebufferInfo, nullptr, &swapChainFramebuffers[i]) != VK_SUCCESS)
                ...
                std::cout << "Vulkan framebuffer " + std::to_string(i) + "/" + std::to_string(swapChainImageViews.size()) + " successfully created !" << std::endl;
        }
    }
    ...
    void createCommandBuffers()
    {
        ...
        for (size_t i = 0; i < commandBuffers.size(); i++)
        {
            ...
            if (vkEndCommandBuffer(commandBuffers[i]) != VK_SUCCESS)
                ...
                std::cout << "Vulkan command " + std::to_string(i) + "/" + std::to_string(commandBuffers.size()) + " successfully recorded !" << std::endl;
        }
    }
